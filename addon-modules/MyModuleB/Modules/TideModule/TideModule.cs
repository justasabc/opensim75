...
{
    [Extension(Path = "/OpenSim/RegionModules", NodeName = "RegionModule", Id = "TideModule")]
    public class TideModule : ISharedRegionModule
    {
        #region Fields
        ...
        private bool m_tideDirection = true;    // which direction is the tide traveling, 'Coming In'(true) or 'Going Out'(false)
        ...
        private Vector3 shoutPos = new Vector3(128f, 128f, 30f);

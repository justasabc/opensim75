...
using log4net;
using Mono.Addins; // kzl: use mono addin
using Nini.Config;
...
namespace MyModule.Region.TestCommand
{
    ...
    // in the places where we use IExampleModule here.
    //
    ...
    [Extension(Path = "/OpenSim/RegionModules", NodeName = "RegionModule", Id = "TestCommandModule")] // kzl: can not change this!
    public class TestCommandModule : IExampleModule, ISharedRegionModule, ICommandableModule
    {
        #region Fields
        // This is our logger. use m_log.InfoFormat("[TestCommandModule]: Logging Something {0}", m_name);
        ...
        // This is a shared module and will service all Scene in the instance. We keep a copy of them here
        ...
        public string m_name = "TestCommandModule";
        ...
        public void PostInitialise ()
        {
            ...
            m_log.InfoFormat("[TestCommandModule]: Running {0} Sequence {1} : Enabled {2}", "PostInitialize", (m_InitCount++).ToString(), m_enabled.ToString());
        ...
        {
            // We just have this to show the sequence
            m_log.InfoFormat("[TestCommandModule]: Running {0} Sequence {1} : Enabled {2}", "Initialize", (m_InitCount++).ToString(), m_enabled.ToString());
            ...
            //
            IConfig cnf = source.Configs["TestCommandModule"];
            
            if (cnf == null)
            {
                m_enabled = false;
                m_log.Info ("[TestCommandModule]: No Configuration Found, Disabled");
                return;
            }
            ...
            if (m_enabled == false)
            {
                m_log.InfoFormat ("[TestCommandModule]: Module was disabled, {0}", m_ExampleMessage);
                return;
            }
            ...
            if (m_ExampleMessage != "")
            {
                m_log.InfoFormat ("[TestCommandModule]: Module was enabled, {0}", m_ExampleMessage);
                m_enabled = true;
            }
        }
        ...
        {
            // We just have this to show the sequence
            m_log.InfoFormat("[TestCommandModule]: Running {0} Sequence {1} : Enabled {2}", "Close", (m_InitCount++).ToString(), m_enabled.ToString());
        ...
        public void AddRegion (Scene scene)
        {
            ...
            m_log.InfoFormat("[TestCommandModule]: Running {0} Sequence {1} : Enabled {2}", "AddRegion", (m_InitCount++).ToString(), m_enabled.ToString());
            ...
            m_log.InfoFormat ("[TestCommandModule]: Adding {0}", scene.RegionInfo.RegionName);
            if (m_enabled == true)
            {
                ...
                // If you module is replacing, then register the interface here
                ...
                Command set_message = new Command("set-message", CommandIntentions.COMMAND_NON_HAZARDOUS, HandleSetMessage, "Set TestCommandModule message");
                ...
                Command get_message = new Command("get-message", CommandIntentions.COMMAND_NON_HAZARDOUS, HandleGetMessage, "Get TestCommandModule message");
        ...
        {
            // We just have this to show the sequence
            m_log.InfoFormat("[TestCommandModule]: Running {0} Sequence {1} : Enabled {2}", "RemoveRegion", (m_InitCount++).ToString(), m_enabled.ToString());
            ...
            // if we run more than one region in the instance
            if (m_Scenes.ContainsKey (scene.RegionInfo.RegionName)) {
                lock (m_Scenes)
                {
        ...
        public void RegionLoaded (Scene scene)
        {
            // We just have this to show the sequence
            // Remove from your real module
            m_log.InfoFormat("[TestCommandModule]: Running {0} Sequence {1} : Enabled {2}", "RegionLoaded", (m_InitCount++).ToString(), m_enabled.ToString());
        ...
        public string Name {
            ...
            get
            {
                ...
                m_log.InfoFormat("[TestCommandModule]: Running {0} Sequence {1} : Enabled {2}", "Name", (m_InitCount++).ToString(), m_enabled.ToString());
                return m_name;
            }
        }
        ...
        public Type ReplaceableInterface {
            ...
            get
            {
                ...
                // Remove from your real module
                m_log.InfoFormat("[TestCommandModule]: Running {0} Sequence {1} : Enabled {2}", "ReplaceableInterface", (m_InitCount++).ToString(), m_enabled.ToString());
        ...
        void OnNewClient (OpenSim.Framework.IClientAPI client)
        {
            ...
            m_log.InfoFormat("[TestCommandModule]: NewClient {0} @ {1}", client.Name, client.RemoteEndPoint.ToString());
        }
        ...
        #region TestCommandModule
        // Constructor
        public TestCommandModule()
        {
            m_log.InfoFormat("[TestCommandModule]: Running {0} Sequence {1} : Enabled {2}", "Constructor", (m_InitCount++).ToString(), m_enabled.ToString());
